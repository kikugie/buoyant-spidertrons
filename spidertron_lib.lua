-- Spidertron library from Spidertron Enhancements mod by Xorimuth
-- https://github.com/tburrows13/SpidertronEnhancements/blob/master/scripts/spidertron_lib.lua
